...
left[0]   = "小さい";
right[0]  = "大きい";
def[0]    = "<p>どの程度の知的·知覚的活動(考える決める，計算する，記憶する，見るなど)を必要とするか．課題がやさしいか難しいか，単純か複雑か，正確さが求められるか大ざっぱでよいか</p>";

scale[1]  = "身体的要求"; 
left[1]   = "小さい";
right[1]  = "大きい";
def[1]    = "<p>どの程度の身体的活動(押す，引く，回す，制御する，動き回るなど)を必要とするか，作業がラクかキツイか，ゆっくりできるかキビキビやらなければならないか，休み休みできるか働きづめか</p>";

scale[2]  = "タイムプレッシャー"; 
left[2]   = "弱い";
right[2]  = "強い";
def[2]    = "<p>仕事のペースや課題が発生する頻度のために感じる時間的切迫感がどの程度か.ペースはゆっくりとして余裕があるものか，それとも速くて余裕のないものか</p>";

scale[3]  = "作業成績"; 
left[3]   = "良い";
right[3]  = "悪い";
def[3]    = "<p>作業指示者(またはあなた自身)によって設定された課題の目標をどの程度達成できたと考えるか．目標の達成に関して自分の作業成績にどの程度満足しているか</p>";

scale[4]  = "努力"; 
left[4]   = "少ない";
right[4]  = "多い";
def[4]    = "<p>作業成績のレベルを達成·維持するために，精神的·身体的にどの程度いっしょうけんめいに作業しなければならないか</p>";

scale[5]  = "フラストレーション"; 
left[5]   = "低い";
right[5]  = "高い";
def[5]    = "<p>作業中に，不安感，落胆，いらいら，ストレス，悩みをどの程度感じるか.あるいは逆に，安心感，満足感，充足感，楽しさ，リラックスをどの程度感じるか</p>";
